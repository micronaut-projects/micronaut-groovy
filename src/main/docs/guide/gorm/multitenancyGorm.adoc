http://gorm.grails.org[GORM] supports Multi-tenancy and integrates with https://docs.micronaut.io/latest/guide/index.html#multitenancy[Micronaut Multi-tenancy] support.
